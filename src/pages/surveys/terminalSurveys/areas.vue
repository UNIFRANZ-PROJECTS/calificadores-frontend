...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "Descripción area", value: "ars_description" },
  ...
  methods: {
    ...
    newItem() {
      ...
      this.areaCampusEstructure.ars_description = '';
    ...
    editItem(item) {
      ...
      this.areaCampusEstructure.ars_description = item.ars_description;
    ...
    confirmDeleteItem(){
      this.$http
        .put("/areas/update/areacampus/"+ this.areaCampusEstructure.id,{
          ...
          "ars_description":this.areaCampusEstructure.ars_description,
    ...
    addItem(item){
      this.$http
        .put("/areas/update/areacampus/"+ item.id,{
          ...
          "ars_description":item.ars_description,
