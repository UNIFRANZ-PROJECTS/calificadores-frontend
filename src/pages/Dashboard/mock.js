...
export default {
  ...
  select: ['Diario', 'Semanalmente', 'Mensual'],
  apexPie: {
    options: {
      dataLabels: {
        enabled: false
  ...
  mainApexArea: {
    options: {
      ...
      colors: [config.light.warning, config.light.primary,'#f3f5ff','#D33C3C','#D3CA3C','#54B924','#79EAE0','#EA79C7','#EE2A07','#26C344'],
      yaxis: {
        axisBorder: {
          show: true,
          color: '#B9B9B980'
